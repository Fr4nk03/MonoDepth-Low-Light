...
def process_map_batch(args):
    ...
    if os.path.isfile(args.image_path):
        ...
        paths = glob.glob(os.path.join(args.image_path, '*.npy'))
    else:
    ...
    for idx, depth_file in enumerate(paths):
    ...
    print(f"Enhanced {len(paths)} depth maps completed!")

if __name__ == '__main__':
    args = parse_args()
    process_map_batch(args)
